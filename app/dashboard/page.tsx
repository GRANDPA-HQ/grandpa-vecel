...
const MENU_CARDS = [
  ...
  },
  {
    ...
    icon: ClipboardList,
    label: "판매품 레시피 작성",
    description: "판매품별 생산품 구성 레시피 등록 및 편집",
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
        {isManager && (
          <Link
            href="/dashboard/employees"
            className="flex flex-col gap-1 rounded-xl border border-violet-100 bg-violet-50 p-5 transition-all hover:shadow-md"
          >
        ...
        <Link
          href="/dashboard/bug-report"
          className="flex flex-col gap-1 rounded-xl border border-red-100 bg-red-50 p-5 transition-all hover:shadow-md"
        >
        ...
        <Link
          href="/dashboard/recipe-guide"
          className="flex flex-col gap-1 rounded-xl border border-orange-100 bg-orange-50 p-5 transition-all hover:shadow-md"
        >
